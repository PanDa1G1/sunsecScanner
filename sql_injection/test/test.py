...
class Boolen_Scan():
    ...
    def __init__(self,url,method = "GET",file = "header.txt",string = "",not_string = "",thread_num = 50):
        self.url = url
        self.method = method
        self.header_file = file
        self.string = string
        self.not_string = not_string
        self.paylaodFile = "test1.txt"
        self.headers =  {
        ...
        while not self.queue_.empty():
            ...
            if self.string:
                ...
                if ratio <0.994:
                    ...
                    #print(TruePayload,FalsePayload,ratio,TruePage,FalsePage,sep = "\n")
                    pass
...
if __name__ == "__main__":
    a = Boolen_Scan("http://127.0.0.1/sqli-labs-master/Less-15/",thread_num = 100,method="POST")
    a.start()
